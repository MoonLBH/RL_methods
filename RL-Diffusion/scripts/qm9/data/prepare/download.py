...
def prepare_dataset(datadir, dataset, subset=None, splits=None, cleanup=True, force_download=False, pt_file_path=None):
    """
    ...
    if new_download or force_download:
        ...
        download_dataset_qm9(datadir, dataset, splits, cleanup=cleanup, pt_file_path=pt_file_path)

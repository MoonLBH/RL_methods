...
def train_epoch(args, loader, epoch, model, model_dp, model_ema, ema, device, dtype, property_norms, optim,
    ...
    avg_nll = epoch_metrics['nll'] / n_iterations
    avg_loss = epoch_metrics['loss'] / n_iterations
    avg_grad_norm = epoch_metrics['grad_norm'] / n_iterations

    print(f"Epoch: {epoch}, Avg Loss: {avg_loss:.4f}, Avg NLL: {avg_nll:.4f}, Avg Grad Norm: {avg_grad_norm:.4f}")
    # print(f"Train Epoch NLL: {np.mean(nll_epoch)}")

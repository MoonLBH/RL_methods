...
log_file="uncertainty_${dataset}_${property}_${timestamp}.log"

nohup taskset -c 0-20 python3 -u uncertain.py \
        --dataset $dataset\
        --property $property\
        --timestamp $timestamp\
        > /data/lab_ph/kyle/projects/DrugDesign/uncertainty/logs/$log_file 2>&1 &
